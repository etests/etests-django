...
urlpatterns = [
    ...
    path("enrollments/student/", enrollment.EnrollmentListCreateView.as_view()),
    path("enrollments/student/<int:pk>/", enrollment.EnrollmentDeleteView.as_view()),
    path(
        "enrollments/<int:pk>/",
    ...
    path("evaluate/<int:pk>/", test.TestEvaluationView.as_view()),
